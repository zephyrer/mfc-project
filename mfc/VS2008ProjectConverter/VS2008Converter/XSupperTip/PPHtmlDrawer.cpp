...
{
	TRACE(_T("in CPPHtmlDrawer::OnSetCursor\n"));
...
//		m_arrTableSizes.clear();
	...
	_tcsncpy_s(m_lfDefault.lfFaceName, m_defStyle.sFaceFont, 
		sizeof(m_lfDefault.lfFaceName)/sizeof(TCHAR)-1);
	TRACE(_T("m_defStyle.sFaceFont=%s =========\n"), m_defStyle.sFaceFont);
	...
	{
		m_hFont = ::CreateFontIndirect(&m_lfDefault);
		TRACE(_T("m_lfDefault.lfFaceName=%s =========\n"), m_lfDefault.lfFaceName);
	}
	// new jms code ends
...
void CPPHtmlDrawer::SetDefaultStyles(_STRUCT_CHANGESTYLE & /*cs*/)
{
	...
	TRACE(_T("SetDefaultStyles:  m_defStyle.sFaceFont=%s =========\n"), m_defStyle.sFaceFont);
